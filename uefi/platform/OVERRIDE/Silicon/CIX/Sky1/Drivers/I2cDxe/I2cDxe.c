...
DEBUG ((DEBUG_ERROR, "XXXXXXXX I2cMemoryInitEventNotify() - ENTER\n"));
...
DEBUG ((DEBUG_ERROR, "XXXXXXXX I2cBus %d, RuntimeMmioRegionBase 0x%016lx, RuntimeMmioRegionSize 0x%08x\n", I2cBus, RuntimeMmioRegionBase, RuntimeMmioRegionSize));
...
DEBUG ((DEBUG_ERROR, "XXXXXXXX ConfigData->Fch.I2c[%d].Enable = %d\n", I2cBus, ConfigData->Fch.I2c[I2cBus].Enable));
DEBUG ((DEBUG_ERROR, "         ConfigData->Fch.I2c[%d].BusFreq = %d\n", I2cBus, ConfigData->Fch.I2c[I2cBus].BusFreq));
DEBUG ((DEBUG_ERROR, "         ConfigData->Fch.I2c[%d].MutexId = %d\n", I2cBus, ConfigData->Fch.I2c[I2cBus].MutexId));
